...
public:
	...
	btCollisionObjectWrapper(const btCollisionObjectWrapper* parent, const btCollisionShape* shape, const btCollisionObject* const collisionObject, const btTransform& worldTransform, int partId, int index)
    ...
    btCollisionObjectWrapper(const btCollisionObjectWrapper* parent, const btCollisionShape* shape, const btCollisionObject* const collisionObject, const btTransform& worldTransform, const btTransform& preTransform, int partId, int index)
